          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            {isAuthenticated ? (
              <>
                <Link
                  to="/admin/dashboard"
                  className="flex items-center px-4 py-2 text-sm font-medium text-white bg-slate-900 dark:bg-slate-800 dark:hover:bg-slate-700 rounded-lg hover:bg-slate-800 transition"
                >
                ...
                <button
                  onClick={logout}
                  className="px-3 py-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white transition"
                >
                  Logout
                </button>
              </>
              ...
              <Link
                to="/login"
                className="px-4 py-2 border border-slate-200 dark:border-slate-700 hover:border-slate-350 dark:hover:border-slate-500 text-sm font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 transition"
              >
                Admin Gateway
              </Link>
            )}
